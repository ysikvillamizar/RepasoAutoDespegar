...
public class DataPageFlight extends PageObject{
	...
	public static final Target ORIGINCITY= Target.the("Select the origin city").locatedBy("//div[@class='sbox-3-input -md sbox-3-validation -top-right -icon-left sbox-origin-container places-inline sbox-bind-error-flight-roundtrip-origin-empty']//input[@placeholder='Ingresa desde dónde viajas']");
